...
import org.adempiere.webstore.util.WebInfo;
...
public class RequestServlet extends HttpServlet
{
		...
		throws ServletException, IOException
	{
		...
		{
			WebstoreUtil.createErrorPage(request, response, this, "No Data Received");
			return;
		}
		...
		if (R_Request_ID == 0)
		{
			...
			if (!req.save())
			{
				...
				WebstoreUtil.createErrorPage (request, response, this, 
